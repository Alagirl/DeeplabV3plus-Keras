...
def Deeplabv3(weights='pascal_voc', input_tensor=None, input_shape=(512, 512, 3), classes=5, backbone='mobilenetv2',
                  OS=16, alpha=1.):
    ...
    # x = Conv2D(1, 1, kernel_regularizer=regularizers.l2(1e-5), )(x)
